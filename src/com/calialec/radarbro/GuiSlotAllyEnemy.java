...
/* 54:   */   }
/* 55:   */   
/* 56:   */   protected void drawSlot(int var1, int var2, int var3, int var4, int var5, int var6)
/* 57:   */   {
/* 58:57 */     String playerUsername = (String)GuiAllyEnemyManager.getAllyList(this.parentGui).get(var1);
/* 59:58 */     this.parentGui.drawCenteredString(this.parentGui.mc.fontRendererObj, "§c" + playerUsername, this.parentGui.width / 2, var3 + 1, 16777215);

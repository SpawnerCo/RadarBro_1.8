...
/* 100: 94 */         mc.fontRendererObj.drawString("(" + (int)mc.thePlayer.posX, -8 - mc.fontRendererObj.getStringWidth("(" + (int)mc.thePlayer.posX), 134, 14737632);
/* 101: 95 */         mc.fontRendererObj.drawString("," + (int)mc.thePlayer.posY + "," + (int)mc.thePlayer.posZ + ")", -8, 134, 14737632);
...
/* 338:    */               }
/* 339:    */             }
/* 340:324 */             if ((mod_RadarBro.EnemyList.contains(user)) && (mod_RadarBro.RadarEnemy))
/* 341:    */             {
...
/* 350:333 */                 drawPlayerHeadImage(generatePlayerHeadImage(user), (dPosX + 5) / 2, (dPosZ + 5) / 2);
/* 351:    */               } else {
...
/* 458:    */     }
/* 459:438 */     mod_RadarBro.itemRenderer.renderItemIntoGUI(is, -8, -8);
...
/* 494:    */     {
/* 495:470 */       drawCenteredString(fontRendererObj, username, x, y - 18, 3665978);
/* 496:    */     }
/* 497:472 */     else if (mod_RadarBro.EnemyList.contains(username))
/* 498:    */     {
/* 499:473 */       drawCenteredString(fontRendererObj, username, x, y - 18, 15742782);
/* 500:    */     }
/* 501:475 */     else if (mod_RadarBro.RadarColorPlayerNames)
/* 502:    */     {
/* 503:476 */       drawCenteredString(fontRendererObj, username, x, y - 18, 14737632);
/* 504:    */     }
/* 505:    */     else
/* 506:    */     {
...
/* 509:    */       }
/* 510:481 */       drawCenteredString(fontRendererObj, username, x, y - 18, 14737632);
/* 511:    */     }
...
/* 564:    */         try
/* 565:    */         {
/* 566:529 */           bi = ImageIO.read(mc.getResourceManager().getResource(AbstractClientPlayer.getLocationSkin("Notch")).getInputStream());

...
/* 74: */{
	...
	/* 76: 74 */public static final ResourceLocation radaricons = new ResourceLocation(
			"mod_RadarBro/textures/radaricons.png");
		...
		/* 92: */{
			...
			/* 96: 91 */GL11
					.glTranslatef(
							i
									- 65
									+ (GuiRepositionRadarBro.xDisplacement + GuiRepositionRadarBro.xEndDisplacement),
							65 + (GuiRepositionRadarBro.yDisplacement + GuiRepositionRadarBro.yEndDisplacement),
							0.0F);
			/* 97: 92 */if (mod_RadarBro.RadarCoordinates)
			/* 98: */{
				/* 99: 93 */GL11.glScalef(0.5F, 0.5F, 0.5F);
				/* 100: 94 */mc.fontRendererObj.drawString(
						"(" + (int) mc.thePlayer.posX,
						-8
								- mc.fontRendererObj.getStringWidth("("
										+ (int) mc.thePlayer.posX), 134,
						14737632);
				/* 101: 95 */mc.fontRendererObj.drawString(","
						+ (int) mc.thePlayer.posY + ","
						+ (int) mc.thePlayer.posZ + ")", -8, 134, 14737632);
				/* 102: 96 */GL11.glScalef(2.0F, 2.0F, 2.0F);
				/* 103: */}
			/* 104: 98 */if (mod_RadarBro.RadarAutoRotate) {
				/* 105: 99 */GL11.glRotatef(-mc.thePlayer.rotationYaw, 0.0F,
						0.0F, 1.0F);
				/* 106: */}
			/* 107: */try
			/* 108: */{
			...
			/* 134:129 */if (mod_RadarBro.RadarAutoRotate) {
				/* 135:130 */GL11.glRotatef(mc.thePlayer.rotationYaw, 0.0F,
						0.0F, 1.0F);
				/* 136: */}
	...
	/* 143: */{
		/* 144:138 */if (mod_RadarBro.RadarWaypoint) {
			...
			/* 146: */{
				/* 147:141 */String[] waypointInfo = mod_RadarBro.Waypoints
						.get(j41).toString().split(",");
				/* 148:142 */int waypointX = (int) Double
						.parseDouble(waypointInfo[0]);
				/* 149:143 */int waypointY = (int) Double
						.parseDouble(waypointInfo[1]);
				/* 150:144 */int waypointZ = (int) Double
						.parseDouble(waypointInfo[2]);
				...
				/* 156:150 */if (enabled.equals("true")) {
					...
					/* 158: */{
						...
						/* 161:154 */mod_RadarBro.WaypointLastInRangePosition
								.put(mod_RadarBro.Waypoints.get(j41).toString(),
										posX + "," + posZ);
						/* 162: */}
					/* 163: */else
					/* 164: */{
						/* 165: */try
						/* 166: */{
							/* 167:157 */String[] lastposition = mod_RadarBro.WaypointLastInRangePosition
									.get(mod_RadarBro.Waypoints.get(j41)
											.toString()).split(",");
							/* 168:158 */int lastposX = Integer
									.parseInt(lastposition[0]);
							/* 169:159 */int lastposZ = Integer
									.parseInt(lastposition[1]);
							/* 170:160 */drawIconRadarWaypointIcon(lastposX,
									lastposZ);
							/* 171:161 */drawRadarNames(lastposX, lastposZ,
									name);
							/* 172: */}
		...
		/* 179: */{
			...
			/* 182: */{
				...
				/* 187:176 */int tileEntPosX = Math.round(tileEntityPos.getX());
				/* 188:177 */int tileEntPosY = Math.round(tileEntityPos.getY());
				/* 189:178 */int tileEntPosZ = Math.round(tileEntityPos.getZ());
				...
				/* 194: */{
					/* 195:183 */if (((tileEntity instanceof TileEntityChest))
							&& (mod_RadarBro.RadarChest)) {
						/* 196:184 */drawIconRadarIcon(dPosX, dPosZ, 16, 32);
						/* 197: */}
					/* 198:186 */if (((tileEntity instanceof TileEntityEnderChest))
							&& (mod_RadarBro.RadarChest)) {
						/* 199:187 */drawIconRadarIcon(dPosX, dPosZ, 64, 32);
						/* 200: */}
					/* 201:189 */if (((tileEntity instanceof TileEntityMobSpawner))
							&& (mod_RadarBro.RadarMonsterSpawner)) {
		...
		/* 215: */{
			/* 216:203 */Entity entity = entities.get(i);
			...
			/* 226:213 */if ((Math.hypot(dPosX, dPosZ) < 130.0D)
					&& (entity != mc.thePlayer))
			/* 227: */{
				/* 228:214 */if (((entity instanceof EntityBat))
						&& (mod_RadarBro.RadarBat)) {
					/* 229:215 */drawIconRadarIcon(dPosX, dPosZ, 80, 32);
					/* 230: */}
				/* 231:217 */if (((entity instanceof EntityChicken))
						&& (mod_RadarBro.RadarChicken)) {
					/* 232:218 */drawIconRadarIcon(dPosX, dPosZ, 32, 0);
					/* 233: */}
				/* 234:220 */if (((entity instanceof EntityCow))
						&& (mod_RadarBro.RadarCow)
						&& (!(entity instanceof EntityMooshroom))) {
					/* 235:221 */drawIconRadarIcon(dPosX, dPosZ, 48, 0);
					/* 236: */}
				/* 237:223 */if (((entity instanceof EntityMooshroom))
						&& (mod_RadarBro.RadarMooshroom)) {
					/* 238:224 */drawIconRadarIcon(dPosX, dPosZ, 144, 0);
					/* 239: */}
				/* 240:226 */if (((entity instanceof EntityOcelot))
						&& (mod_RadarBro.RadarOcelot)) {
					/* 241:227 */drawIconRadarIcon(dPosX, dPosZ, 240, 16);
					/* 242: */}
				/* 243:229 */if (((entity instanceof EntityPig))
						&& (mod_RadarBro.RadarPig)) {
					/* 244:230 */drawIconRadarIcon(dPosX, dPosZ, 160, 0);
					/* 245: */}
				/* 246:232 */if (((entity instanceof EntitySheep))
						&& (mod_RadarBro.RadarSheep)) {
					/* 247:233 */drawIconRadarIcon(dPosX, dPosZ, 176, 0);
					/* 248: */}
				/* 249:235 */if (((entity instanceof EntitySnowman))
						&& (mod_RadarBro.RadarSnowGolem)) {
					/* 250:236 */drawIconRadarIcon(dPosX, dPosZ, 240, 0);
					/* 251: */}
				/* 252:238 */if (((entity instanceof EntitySquid))
						&& (mod_RadarBro.RadarSquid)) {
					/* 253:239 */drawIconRadarIcon(dPosX, dPosZ, 16, 16);
					/* 254: */}
				/* 255:241 */if (((entity instanceof EntityVillager))
						&& (mod_RadarBro.RadarVillager)) {
					/* 256:242 */drawIconRadarIcon(dPosX, dPosZ, 80, 16);
					/* 257: */}
				/* 258:244 */if (((entity instanceof EntityBlaze))
						&& (mod_RadarBro.RadarBlaze)) {
					/* 259:245 */drawIconRadarIcon(dPosX, dPosZ, 0, 0);
					/* 260: */}
				/* 261:247 */if (((entity instanceof EntityCaveSpider))
						&& (mod_RadarBro.RadarCaveSpider)) {
					/* 262:248 */drawIconRadarIcon(dPosX, dPosZ, 16, 0);
					/* 263: */}
				/* 264:250 */if (((entity instanceof EntityCreeper))
						&& (mod_RadarBro.RadarCreeper)) {
					/* 265:251 */drawIconRadarIcon(dPosX, dPosZ, 64, 0);
					/* 266: */}
				/* 267:253 */if (((entity instanceof EntityDragon))
						&& (mod_RadarBro.RadarEnderdragon)) {
					/* 268:254 */drawIconRadarIcon(dPosX, dPosZ, 80, 0);
					/* 269: */}
				/* 270:256 */if (((entity instanceof EntityGhast))
						&& (mod_RadarBro.RadarGhast)) {
					/* 271:257 */drawIconRadarIcon(dPosX, dPosZ, 112, 0);
					/* 272: */}
				/* 273:259 */if (((entity instanceof EntityMagmaCube))
						&& (mod_RadarBro.RadarMagmaCube)) {
					/* 274:260 */drawIconRadarIcon(dPosX, dPosZ, 128, 0);
					/* 275: */}
				/* 276:262 */if (((entity instanceof EntitySilverfish))
						&& (mod_RadarBro.RadarSilverfish)) {
					/* 277:263 */drawIconRadarIcon(dPosX, dPosZ, 192, 0);
					/* 278: */}
				/* 279:265 */if (((entity instanceof EntitySkeleton))
						&& (mod_RadarBro.RadarSkeleton)) {
					/* 280:266 */drawIconRadarIcon(dPosX, dPosZ, 208, 0);
					/* 281: */}
				/* 282:268 */if (((entity instanceof EntitySlime))
						&& (mod_RadarBro.RadarSlime)
						&& (!(entity instanceof EntityMagmaCube))) {
					/* 283:269 */drawIconRadarIcon(dPosX, dPosZ, 224, 0);
					/* 284: */}
				/* 285:271 */if (((entity instanceof EntitySpider))
						&& (mod_RadarBro.RadarSpider)) {
					/* 286:272 */drawIconRadarIcon(dPosX, dPosZ, 0, 16);
					/* 287: */}
				/* 288:274 */if (((entity instanceof EntityWitch))
						&& (mod_RadarBro.RadarWitch)) {
					/* 289:275 */drawIconRadarIcon(dPosX, dPosZ, 96, 32);
					/* 290: */}
				/* 291:277 */if (((entity instanceof EntityWither))
						&& (mod_RadarBro.RadarWither)) {
					/* 292:278 */drawIconRadarIcon(dPosX, dPosZ, 112, 32);
					/* 293: */}
				/* 294:280 */if (((entity instanceof EntityZombie))
						&& (mod_RadarBro.RadarZombie)) {
					/* 295:281 */drawIconRadarIcon(dPosX, dPosZ, 48, 16);
					/* 296: */}
				/* 297:283 */if (((entity instanceof EntityEnderman))
						&& (mod_RadarBro.RadarEnderman)) {
					/* 298:284 */drawIconRadarIcon(dPosX, dPosZ, 96, 0);
					/* 299: */}
				/* 300:286 */if (((entity instanceof EntityIronGolem))
						&& (mod_RadarBro.RadarIronGolem)) {
					/* 301:287 */drawIconRadarIcon(dPosX, dPosZ, 0, 32);
					/* 302: */}
				/* 303:289 */if (((entity instanceof EntityWolf))
						&& (mod_RadarBro.RadarWolf)) {
					/* 304:290 */drawIconRadarIcon(dPosX, dPosZ, 32, 16);
					/* 305: */}
				/* 306:292 */if (((entity instanceof EntityPigZombie))
						&& (mod_RadarBro.RadarZombiePigman)) {
					/* 307:293 */drawIconRadarIcon(dPosX, dPosZ, 64, 16);
					/* 308: */}
				/* 309:295 */if (((entity instanceof EntityArrow))
						&& (mod_RadarBro.RadarArrow)) {
					/* 310:296 */drawIconRadarIcon(dPosX, dPosZ, 112, 16);
					/* 311: */}
				/* 312:298 */if (((entity instanceof EntityBoat))
						&& (mod_RadarBro.RadarBoat)) {
					/* 313:299 */drawIconRadarIcon(dPosX, dPosZ, 128, 16);
					/* 314: */}
				/* 315:301 */if (((entity instanceof EntityItem))
						&& (mod_RadarBro.RadarItem))
				/* 316: */{
					/* 317:302 */EntityItem entitem = (EntityItem) entities
							.get(i);
					/* 318:303 */drawIconRadarItemIcon(dPosX, dPosZ,
							entitem.getEntityItem());
					/* 319: */}
				/* 320:305 */if (((entity instanceof EntityMinecart))
						&& (mod_RadarBro.RadarMinecart)) {
					/* 321:306 */drawIconRadarIcon(dPosX, dPosZ, 160, 16);
					/* 322: */}
				/* 323:308 */if (((entity instanceof EntityPainting))
						&& (mod_RadarBro.RadarPainting)) {
					/* 324:309 */drawIconRadarIcon(dPosX, dPosZ, 176, 16);
					/* 325: */}
				/* 326:311 */if (((entity instanceof EntityXPOrb))
						&& (mod_RadarBro.RadarXPOrb)) {
					/* 327:312 */drawIconRadarIcon(dPosX, dPosZ, 192, 16);
					/* 328: */}
				/* 329:314 */if ((entity instanceof EntityPlayer)) {
					/* 330: */try
					/* 331: */{
						/* 332:316 */EntityOtherPlayerMP eop = (EntityOtherPlayerMP) entities
								.get(i);
						String user = eop.getName();
						/* 333:318 */if (mod_RadarBro.AllyList.contains(user))
						/* 334: */{
							/* 335:319 */drawIconRadarIcon(dPosX, dPosZ, 208,
									16);
							/* 336:320 */if (mod_RadarBro.RadarPlayerNames) {
								/* 337:321 */drawRadarNames(dPosX, dPosZ, user);
								/* 338: */}
							/* 339: */}
						/* 340:324 */if ((mod_RadarBro.EnemyList.contains(user))
								&& (mod_RadarBro.RadarEnemy))
						/* 341: */{
							/* 342:325 */drawIconRadarIcon(dPosX, dPosZ, 224,
									16);
							/* 343:326 */if (mod_RadarBro.RadarPlayerNames) {
								/* 344:327 */drawRadarNames(dPosX, dPosZ, user);
								/* 345: */}
							/* 346: */}
						/* 347:331 */if (mod_RadarBro.RadarPlayer)
						/* 348: */{
							/* 349:332 */if (mod_RadarBro.RadarUsePlayerSkinTexture) {
								/* 350:333 */drawPlayerHeadImage(
										generatePlayerHeadImage(user),
										(dPosX + 5) / 2, (dPosZ + 5) / 2);
								/* 351: */} else {
								/* 352:335 */drawIconRadarIcon(dPosX, dPosZ,
										96, 16);
								/* 353: */}
							/* 354:337 */if (mod_RadarBro.RadarPlayerNames) {
								/* 355:338 */drawRadarNames(dPosX, dPosZ, user);
								/* 356: */}
							/* 357: */}
						/* 358: */}
	...
	/* 364: */
	/* 365: */public static void drawCircle(int x, int y, double r, int c,
			boolean filled)
	/* 366: */{
	...
	/* 390: */{
		...
		/* 392: */{
			...
			/* 395:376 */GL11.glRotatef(-mc.thePlayer.rotationYaw, 0.0F, 0.0F,
					1.0F);
			/* 396: */}
	...
	/* 433: */{
		...
		/* 440:422 */if (mod_RadarBro.RadarAutoRotate) {
			/* 441:423 */GL11.glRotatef(mc.thePlayer.rotationYaw, 0.0F, 0.0F,
					1.0F);
			/* 442: */}
	...
	public void drawIconRadarItemIcon(int x, int y, ItemStack is)
	{
		...
		try
		{
			...
			//drawTexturedModalRect(-8, -8, 1, 1, 16, 16);
			/* 444:425 */GL11.glTranslatef(-x - 1, -y - 1, 0.0F);
			/* 445:426 */GL11.glScalef(2.0F, 2.0F, 2.0F);
			/* 446:427 */GL11.glDisable(2896);
			/* 447:428 */GL11.glDisable(3042);
	...
	public void renderToHud(ItemStack is, int x, int y)
	{
	...
	/* 467: */{
		...
		/* 473:451 */if (mod_RadarBro.RadarAutoRotate) {
			/* 474:452 */GL11.glRotatef(
					-mc.thePlayer.rotationYaw / 180.0F - 180.0F, 0.0F, 0.0F,
					1.0F);
			/* 475: */}
	...
	/* 484: */{
		...
		/* 488:464 */if (mod_RadarBro.RadarAutoRotate) {
			/* 489:465 */GL11.glRotatef(mc.thePlayer.rotationYaw, 0.0F, 0.0F,
					1.0F);
			/* 490: */}
		/* 491:467 */GL11.glTranslatef(-x, -y, 0.0F);
		/* 492:468 */FontRenderer fontRendererObj = mc.fontRendererObj;
		/* 493:469 */if (mod_RadarBro.AllyList.contains(username))
		/* 494: */{
			/* 495:470 */drawCenteredString(fontRendererObj, username, x,
					y - 18, 3665978);
			/* 496: */}
		/* 497:472 */else if (mod_RadarBro.EnemyList.contains(username))
		/* 498: */{
			/* 499:473 */drawCenteredString(fontRendererObj, username, x,
					y - 18, 15742782);
			/* 500: */}
		/* 501:475 */else if (mod_RadarBro.RadarColorPlayerNames)
		/* 502: */{
			/* 503:476 */drawCenteredString(fontRendererObj, username, x,
					y - 18, 14737632);
			/* 504: */}
		/* 505: */else
		/* 506: */{
			/* 507:478 */if (username.contains("??")) {
				...
				/* 509: */}
			/* 510:481 */drawCenteredString(fontRendererObj, username, x,
					y - 18, 14737632);
			/* 511: */}
	...
	/* 515: */
	/* 516: */public void drawPlayerHeadImage(BufferedImage bufferedimage,
			int x, int y)
	/* 517: */{
		/* 518:489 */DynamicTexture previewTexture = new DynamicTexture(
				bufferedimage);
		/* 519:490 */ResourceLocation resourceLocation = mc.getTextureManager()
				.getDynamicTextureLocation("preivew", previewTexture);
	...
	/* 526: */
	/* 527: */public static BufferedImage generatePlayerHeadImage(
			String username)
	/* 528: */{
		/* 529:499 */if (username.contains("�")) {
			/* 530:500 */username = username.substring(2);
			/* 531: */}
		/* 532:502 */String skinURL = "http://s3.amazonaws.com/MinecraftSkins/"
				+ username + ".png";
		...
		/* 542: */{
			...
			/* 544: */}
		/* 545:512 */BufferedImage bufferedimage = mod_RadarBro
				.getIconFromCache(skinURL);
		...
		/* 547: */{
			...
			/* 550: */{
				...
				/* 552: */
				/* 553:519 */BufferedImage playerHead = playerSkin.getSubimage(
						8, 8, 8, 8);
				/* 554:520 */BufferedImage playerBody = new BufferedImage(256,
						256, 2);
				...
				/* 558:524 */mod_RadarBro.HeadIconCache
						.put(skinURL, playerBody);
			...
			/* 562: */{
				...
				/* 564: */try
				/* 565: */{
					/* 566:529 */bi = ImageIO.read(mc
							.getResourceManager()
							.getResource(
									AbstractClientPlayer
											.getLocationSkin("Notch"))
							.getInputStream());
					/* 567:530 */BufferedImage playerHead = bi.getSubimage(8,
							8, 8, 8);
					/* 568:531 */BufferedImage playerBody = new BufferedImage(
							256, 256, 2);
					...
					/* 572:535 */mod_RadarBro.HeadIconCache.put(skinURL,
							playerBody);

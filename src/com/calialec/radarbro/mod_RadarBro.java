...
/*  31:    */ 
/*  32:    */ @net.minecraftforge.fml.common.Mod(modid="mod_RadarBro", name="RadarBro", version="v1337.69")
...
/*  40: 46 */   protected static RenderItem itemRenderer = Minecraft.getMinecraft().getRenderItem();
...
/*  94:    */   @net.minecraftforge.fml.common.Mod.Instance("mod_RadarBro")
/*  95:    */   public static mod_RadarBro instance;
/*  96:    */   
/*  97:    */   @net.minecraftforge.fml.common.Mod.EventHandler
/*  98:    */   public void postInit(net.minecraftforge.fml.common.event.FMLPostInitializationEvent event)
/*  99:    */   {
/* 100:114 */     MinecraftForge.EVENT_BUS.register(new GuiRadarBro(Minecraft.getMinecraft()));
/* 101:115 */     net.minecraftforge.fml.common.FMLCommonHandler.instance().bus().register(this);
/* 102:    */   }
/* 103:    */   
/* 104:    */   @net.minecraftforge.fml.common.Mod.EventHandler
/* 105:    */   public void load(net.minecraftforge.fml.common.event.FMLInitializationEvent event)
/* 106:    */   {
/* 107:120 */     mc = Minecraft.getMinecraft();
/* 108:121 */     net.minecraftforge.fml.client.registry.ClientRegistry.registerKeyBinding(this.GUIkey);
...
/* 115:    */   }
/* 116:    */   
/* 117:    */   @net.minecraftforge.fml.common.eventhandler.SubscribeEvent
/* 118:    */   public void onKeyInput(net.minecraftforge.fml.common.gameevent.InputEvent.KeyInputEvent event)
/* 119:    */   {

...
/* 40:   */   }
/* 41:   */   
/* 42:   */   protected void drawSlot(int var1, int var2, int var3, int var4, int var5, int var6)
/* 43:   */   {
...
/* 55:   */     
/* 56:56 */     this.parentGui.drawString(this.parentGui.mc.fontRendererObj, waypointnbtstorage.name, var2 + 2, var3 + 1, 16777215);
/* 57:57 */     this.parentGui.drawString(this.parentGui.mc.fontRendererObj, enabledState, var2 + 2, var3 + 12, 8421504);
/* 58:58 */     this.parentGui.drawString(this.parentGui.mc.fontRendererObj, distance + " blocks away", var2 + 100, var3 + 12, 8421504);
/* 59:59 */     this.parentGui.drawString(this.parentGui.mc.fontRendererObj, "(" + waypointnbtstorage.coordinates + ")", var2 + 2, var3 + 12 + 11, 3158064);

...
/*  43: 40 */     this.waypointName = new GuiTextField(2, this.fontRendererObj, this.width / 2 - 100, 76, 200, 20);
/*  44: 41 */     this.waypointName.setFocused(true);
/*  45: 42 */     this.waypointName.setText(this.waypointNBTStorage.name);
/*  46: 43 */     this.waypointX = new GuiTextField(3, this.fontRendererObj, this.width / 2 - 100, 116, 60, 20);
/*  47: 44 */     this.waypointY = new GuiTextField(4, this.fontRendererObj, this.width / 2 - 30, 116, 60, 20);
/*  48: 45 */     this.waypointZ = new GuiTextField(5, this.fontRendererObj, this.width / 2 + 40, 116, 60, 20);
